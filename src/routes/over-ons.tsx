...
const team = [
  ...
  { initials: "SB", name: "Stef van Boekel", role: "Commercieel Partner", bio: "Met vijftien jaar ervaring op directieniveau in de platformindustrie heeft hij zich ontwikkeld tot een erkend expert, met media-optredens bij BNR, het Financieele Dagblad en MT/Sprout. Zijn vastgoedervaring strekt zich uit over Nederland, België en Italië. Binnen BUGG fungeert hij als centraal aanspreekpunt voor investeerders en vastgoedeigenaren, met ruime fundraising-ervaring, expertise in dealflow en diepgaande ervaring met aandeelhoudersverantwoordelijkheid en strategische belangenafweging.", linkedin: "https://www.linkedin.com/in/stefvanboekel/" },
